...
export  const projectsArray = [
  {
    name: 'functionEarth',
    h2: 'Function Earth',
    description: 'React Native application that tracked what we are doing around the world to reduce our footprint and preserve our environment for future generations. Built a compost bin? Recycled? Picked up trash from the ocean? Helped the elderly? Took care of an animal? Use Function Earth to log these actions. Race other cities, states and countries to be the greenest region in the world!',
    image: FE,
    archived: true,
  ...
  },
  {
    ...
    description: 'MVP React-Native application built to give real time and future tide predictions for the coastal United States. Use BeachTides to search by zip code or city and get beach tide predictions. Search for tide information without creating accounts',
    image: BTM,
    archived: true,
